...
extern boolean UssDrivers_IsrRxFinishFlag_Get(void);
extern void UssDrivers_IsrRxFinishFlag_Set(boolean bFlagStatus);
...
extern Func_Status_t UssDrivers_Status_Read(Uss_Sensor_Id_t tSensorMask);
extern Func_Status_t UssDrivers_Status_Data_Get(Uss_Sensor_Id_t tSensorMask, uint16 *u16StatusData);
